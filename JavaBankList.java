	  ...
	  /**
	    ...
	    private void CreateAccountJButtonActionPerformed(ActionEvent event) {
	    	...
	    	if ((Name != "") & (Accountnum != 0))  {
	        		...
	        		//Display tempAccount
	        		displayJTextArea.setText(Accounts.size() + " " + tempAccount.getAccountName() + " " + tempAccount.getAccountName() + " " + tempAccount.getBalance());
	    	...
	    	if (Accounts.size() == 0) {
	            ...
	            // get the element and set to TempAccount
	                ...
	                if ((tempAccount.accountNum == Accountnum) && (Deposit>0)) {
	        		    ...
	        		    displayJTextArea.setText(tempAccount.getAccountName() + " " + tempAccount.getAccountName() + " " + tempAccount.getBalance());
	    ...
	    private void DisplayJButtonActionPerformed(ActionEvent event) {
	    	...
	    	for (int i=0; i < Accounts.size(); i++) { 
	    		    Account tempAccount = (Account)Accounts.get(i);
	    		    displayJTextArea.append(tempAccount.getAccountName() + " " + tempAccount.getAccountName() + " " + tempAccount.getBalance()  + "\n");
